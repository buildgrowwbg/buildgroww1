        ...
        <StyleToolbar sx={{height:'64px',top:'0'}}>
            ...
            <NavLeft sx={{flex:'9'}}>
                <Logo sx={{marginLeft:{md:'50px'}}}>
                    <Typography onClick={()=>{navigate('/cart')}} component="div" sx={{fontSize: {md:'35px',xs:'20px'},cursor:{md:'pointer',xs:'none'}}}>
                        Cart
                    </Typography>
            ...
            <Cart sx={{flex:'3'}}>
                <Box sx={{display:{md:'flex',xs:'none'},justifyContent:'flex-end',alignItems:'center',paddingLeft:'20px',flex:'2',color:`${theme.header.textColor}`}}>
                    <PhoneIcon/>
                    <Typography sx={{paddingLeft:'5px',fontSize:'20px',fontWeight:'400',color:`${theme.header.textColor}`}}>+91-7300639790</Typography>
                </Box>
