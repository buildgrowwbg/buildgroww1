  ...
  return (
    <Container>
        ...
        <Box sx={{display:'flex',flexDirection:'column',gap:'10px'}}>
           ...
           {(user.currentUser===null || (user.currentUser.data && user.currentUser.data===null)) ? <Typography sx={{fontSize:'18px',textAlign:'center'}}>Please <Link to={'/login'} style={{color:`${theme.colors.success.dark}`,textDecoration:'none',margin:'0 3px',fontSize:'20px'}}>Login</Link> To Check Saved Products</Typography> : null}
        </Box>
